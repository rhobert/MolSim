...
void LinkedCellParticleContainerTest::setUp()
{
	...
	Particle * innerParticle1 = new Particle(innerParticle);
	Particle * innerParticle2 = new Particle(innerParticle);
	Particle * innerParticle3 = new Particle(innerParticle);
	Particle * boundaryParticle1 = new Particle(boundaryParticle);
	Particle * boundaryParticle2 = new Particle(boundaryParticle);
	Particle * haloParticle1 = new Particle(haloParticle);
	Particle * haloParticle2 = new Particle(haloParticle);
